...
donhatchsw.jar: Makefile META-INF/MANIFEST.MF com/donhatchsw/util/MyMath.class com/donhatchsw/util/Arrays.class com/donhatchsw/util/VecMath.class com/donhatchsw/util/LinearProgramming.class com/donhatchsw/util/SortStuff.class com/donhatchsw/util/Minimizer.class com/donhatchsw/util/MyPanel.class com/donhatchsw/util/FuzzyPointHashTable.class com/donhatchsw/util/MergeFind.class com/donhatchsw/util/TopSorter.class com/donhatchsw/util/TriangulationOptimizer.class com/donhatchsw/util/Triangulator.class com/donhatchsw/util/Poly.class com/donhatchsw/util/CSG.class  com/donhatchsw/util/PolyCSG.class com/donhatchsw/util/Arrows.class
	...
	mv -f scratch/com/donhatchsw/util/FuzzyPointHashTable.prejava scratch/com/donhatchsw/util/FuzzyPointHashTable.java
	mv -f scratch/com/donhatchsw/util/MergeFind.prejava scratch/com/donhatchsw/util/MergeFind.java
	mv -f scratch/com/donhatchsw/util/TopSorter.prejava scratch/com/donhatchsw/util/TopSorter.java
	...
	(cd scratch; ${JAVAROOT}/bin/jar -cfm ../donhatchsw.jar ../META-INF/MANIFEST.MF com/donhatchsw/util/*.class com/donhatchsw/util/*.java com/donhatchsw/util/macros.h com/donhatchsw/util/RCS Makefile RCS)

clean:
	/bin/rm -rf *.jar com/donhatchsw/util/*.class scratch com/donhatchsw/util/*.java com/donhatchsw/util/*.java.lines *.html com/donhatchsw/util/*.html *.css
