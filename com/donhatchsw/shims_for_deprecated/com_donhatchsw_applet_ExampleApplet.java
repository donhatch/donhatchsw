...
// !!! THIS FILE WAS AUTOMATICALLY GENERATED BY javacpp; DO NOT EDIT !!!
// !!! THIS FILE WAS AUTOMATICALLY GENERATED BY javacpp; DO NOT EDIT !!!
// 102 # 1 "com/donhatchsw/shims_for_deprecated/com_donhatchsw_applet_ExampleApplet.prejava"
// 103 # 1 "<built-in>"
// 104 # 1 "<command-line>"
...
// 150 # 1 "com/donhatchsw/shims_for_deprecated/com_donhatchsw_applet_ExampleApplet.prejava"

// 152 # 1 "com/donhatchsw/shims_for_deprecated/com_donhatchsw_applet_ExampleApplet.prejava"
...
// 164 # 1 "com/donhatchsw/shims_for_deprecated/macros.h" 1
//
// macros.h
//
// 168 # 14 "com/donhatchsw/shims_for_deprecated/macros.h"
// NOTE: this causes a,b to be evaluated twice on failure, so is not ideal. might be better to do a block... ?
// 170 # 30 "com/donhatchsw/shims_for_deprecated/macros.h"
// Note: the additional "(a)==(b)||" is to make it work correctly for infinities...
// and causes the args to be evaluated twice.
// 173 # 67 "com/donhatchsw/shims_for_deprecated/macros.h"
// XXX ... what a mess
// 175 # 13 "com/donhatchsw/shims_for_deprecated/com_donhatchsw_applet_ExampleApplet.prejava" 2
...
//com_donhatchsw_applet_ExampleApplet.this.setBounds(5 + (foo++%5),28,100,100); // XXX total hack... and THIS is where the bogus clear is.  how can I do it without the clear?
            ...
            @Override public void paint(java.awt.Graphics frontBufferGraphics)
            {
                ...
                if (true)
                {
                    ...
                    {
                        System.out.println(""+"=========================");
                        {System.out.print("        "); System.out.println("getClass().getSuperclass()" + " = " + (getClass().getSuperclass()));};
                        {System.out.print("        "); System.out.println("getSize()" + " = " + (getSize()));};
                        {System.out.print("        "); System.out.println("getParent().getClass().getSuperclass()" + " = " + (getParent().getClass().getSuperclass()));};
                        {System.out.print("        "); System.out.println("getParent().getSize()" + " = " + (getParent().getSize()));};
                        {System.out.print("        "); System.out.println("getParent().getParent().getClass().getSuperclass()" + " = " + (getParent().getParent().getClass().getSuperclass()));};
                        {System.out.print("        "); System.out.println("getParent().getParent().getSize()" + " = " + (getParent().getParent().getSize()));};
                        if (getParent().getParent().getParent() != null)
                        {
                            {System.out.print("        "); System.out.println("getParent().getParent().getParent().getClass().getSuperclass()" + " = " + (getParent().getParent().getParent().getClass().getSuperclass()));};
                            {System.out.print("        "); System.out.println("getParent().getParent().getParent().getSize()" + " = " + (getParent().getParent().getParent().getSize()));};
                        }
                        System.out.println(""+"=========================");
                    }
    ...
    private void makeAndAddTheEventListeners(java.awt.Component canvas)
    {
        ...
        canvas.addKeyListener(new java.awt.event.KeyListener() {
                public void keyPressed(java.awt.event.KeyEvent e)
                {
                    ...
                    if (eventVerbose >= 2) {System.out.print("        "); System.out.println("(int)e.getKeyChar()+0" + " = " + ((int)e.getKeyChar()+0));}; // XXX +0 necessary, don't know why
                    if (eventVerbose >= 2) {System.out.print("        "); System.out.println("e.isControlDown()" + " = " + (e.isControlDown()));};
                    if (e.isControlDown())
                        controlIsDown = true;
                    else
                        controlIsDown = false;
                    ...
                    if (eventVerbose >= 2) {System.out.print("        "); System.out.println("e.isControlDown()" + " = " + (e.isControlDown()));};
                    if (eventVerbose >= 2) {System.out.print("        "); System.out.println("e.isShiftDown()" + " = " + (e.isShiftDown()));};
                ...
                public void keyTyped(java.awt.event.KeyEvent e)
                {
                    ...
                    switch (c)
                    {
                        ...
                        case (('r')-'a'+1): // reset but same size
                            //reset(false);
                            e.getComponent().repaint();
                            break;
                        default:
