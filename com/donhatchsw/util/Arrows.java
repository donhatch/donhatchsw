...
// !!! THIS FILE WAS AUTOMATICALLY GENERATED BY javacpp; DO NOT EDIT !!!
// !!! THIS FILE WAS AUTOMATICALLY GENERATED BY javacpp; DO NOT EDIT !!!
// 102 # 1 "com/donhatchsw/util/Arrows.prejava"
// 103 # 1 "<built-in>"
// 104 # 1 "<command-line>"
// 105 # 1 "com/donhatchsw/util/Arrows.prejava"
...
// XXX ... what a mess
// 122 # 7 "com/donhatchsw/util/Arrows.prejava" 2
//
...
public class Arrows
{
            ...
            boolean doArrowHeadOnSingleSrc)
    {
        ...
        else if (nSrcs == 1 && nDsts == 0)
        {
            ...
            do { if (!((iCurve)==(nCurves))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrows.prejava"+"("+183 +"): (" + "iCurve" + ")" + "==" + "(" + "nCurves" + ") ("+(iCurve)+" vs. "+(nCurves)+")"); } while (false);
            return curves;
        }
        else if (nDsts == 1 && nSrcs == 0)
        {
            ...
            curves[iCurve++] = arrowHeadSide(nothingness[0], nothingness[1],
                                             ...
                                             arrowHeadLength,
                                             -Math.PI*5/6);
            do { if (!((iCurve)==(nCurves))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrows.prejava"+"("+213 +"): (" + "iCurve" + ")" + "==" + "(" + "nCurves" + ") ("+(iCurve)+" vs. "+(nCurves)+")"); } while (false);
            return curves;
        }
        else if (nSrcs == 2 && nDsts == 0)
        {
            ...
            curves[iCurve++] = new java.awt.geom.CubicCurve2D.Double(
                                                ...
                                                B[0], B[1],
                                                B[0], B[1]);
            do { if (!((iCurve)==(nCurves))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrows.prejava"+"("+242 +"): (" + "iCurve" + ")" + "==" + "(" + "nCurves" + ") ("+(iCurve)+" vs. "+(nCurves)+")"); } while (false);
            return curves;
        }
        else if (nDsts == 0)
        {
            ...
            do { if (!((iCurve)==(nCurves))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrows.prejava"+"("+263 +"): (" + "iCurve" + ")" + "==" + "(" + "nCurves" + ") ("+(iCurve)+" vs. "+(nCurves)+")"); } while (false);
            return curves;
        }
        else if (nDsts == 2 && nSrcs == 0)
        {
            ...
            do { if (!((iCurve)==(nCurves))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrows.prejava"+"("+305 +"): (" + "iCurve" + ")" + "==" + "(" + "nCurves" + ") ("+(iCurve)+" vs. "+(nCurves)+")"); } while (false);
            return curves;
        }
        else if (nSrcs == 0)
        {
            ...
            do { if (!((iCurve)==(nCurves))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrows.prejava"+"("+339 +"): (" + "iCurve" + ")" + "==" + "(" + "nCurves" + ") ("+(iCurve)+" vs. "+(nCurves)+")"); } while (false);
            return curves;
        }
        else // nSrcs > 0 && nDsts > 0
        {
            ...
            curves[iCurve++] = new java.awt.geom.CubicCurve2D.Double(
                ...
                B[0], B[1],
                B[0], B[1]);
            do { if (!((iCurve)==(nCurves))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrows.prejava"+"("+409 +"): (" + "iCurve" + ")" + "==" + "(" + "nCurves" + ") ("+(iCurve)+" vs. "+(nCurves)+")"); } while (false);
            return curves;
        }
    } // getCurves
        ...
        private static double[] average(double points[][/*dim*/], int inds[])
        {
            ...
            for (int i = 0; i < n; ++i)
            {
                ...
                do { if (!((point.length)==(dim))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrows.prejava"+"("+437 +"): (" + "point.length" + ")" + "==" + "(" + "dim" + ") ("+(point.length)+" vs. "+(dim)+")"); } while (false);
                for (int j = 0; j < dim; ++j)
                    result[j] += point[j];
            }
            for (int j = 0; j < dim; ++j)
                               ...
                               String addressForDebugging)
    {
        ...
        if (leftResult)
        {
            ...
            do { if (!(newTooFarSqrd < tooFar*tooFar)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrows.prejava"+"("+596 +"): " + "newTooFarSqrd < tooFar*tooFar" + ""); } while (false); // it shouldn't have succeeded otherwise
        ...
        for (int j = 0; j < curves[i].length; ++j)
        {
            if (curves[i][j] instanceof java.awt.geom.CubicCurve2D)
            {
                                                ...
                                                0)) // verbose
                {
                    ...
                    do { if (!(newTooFarSqrd < tooFar*tooFar)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrows.prejava"+"("+663 +"): " + "newTooFarSqrd < tooFar*tooFar" + ""); } while (false); // it shouldn't have succeeded otherwise
                    tooFar = Math.sqrt(newTooFarSqrd);
                }
            }
        }
    ...
    //
        ...
        {
            int n = a.length;
            do { if (!((n)==(b.length))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrows.prejava"+"("+730 +"): (" + "n" + ")" + "==" + "(" + "b.length" + ") ("+(n)+" vs. "+(b.length)+")"); } while (false);
    ...
    //
         ...
         */
        public static void drawStringNextToPoint(java.awt.Graphics2D g2d, String labelText, double x, double y, double dirAngle, double margin)
        {
        ...
        public static void drawCurveSubdivided(java.awt.Graphics2D g2d, java.awt.geom.CubicCurve2D curve, int nLevels)
        {
            ...
            else
            {
                ...
                do { if (!(!Double.isNaN(curve.getX1()))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrows.prejava"+"("+861 +"): " + "!Double.isNaN(curve.getX1())" + ""); } while (false);
                do { if (!(!Double.isNaN(curve.getY1()))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrows.prejava"+"("+862 +"): " + "!Double.isNaN(curve.getY1())" + ""); } while (false);
                do { if (!(!Double.isNaN(curve.getCtrlX1()))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrows.prejava"+"("+863 +"): " + "!Double.isNaN(curve.getCtrlX1())" + ""); } while (false);
                do { if (!(!Double.isNaN(curve.getCtrlY1()))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrows.prejava"+"("+864 +"): " + "!Double.isNaN(curve.getCtrlY1())" + ""); } while (false);
                do { if (!(!Double.isNaN(curve.getCtrlX2()))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrows.prejava"+"("+865 +"): " + "!Double.isNaN(curve.getCtrlX2())" + ""); } while (false);
                do { if (!(!Double.isNaN(curve.getCtrlY2()))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrows.prejava"+"("+866 +"): " + "!Double.isNaN(curve.getCtrlY2())" + ""); } while (false);
                do { if (!(!Double.isNaN(curve.getX2()))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrows.prejava"+"("+867 +"): " + "!Double.isNaN(curve.getX2())" + ""); } while (false);
                do { if (!(!Double.isNaN(curve.getY2()))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrows.prejava"+"("+868 +"): " + "!Double.isNaN(curve.getY2())" + ""); } while (false);
                g2d.draw(curve);
            }
        } // drawCurveSubdivided
    //
    ...
    public static class MyDemoPanel
        extends javax.swing.JPanel
    {
            ...
            extends javax.swing.JPanel
        {
            ...
            @Override public void paintComponent(java.awt.Graphics g)
            {
                ...
                if (false)
                {
                    // print the stack trace, so I can ponder why
                    // this works so well when resizing but
                    // a simple applet with a canvas doesn't
                ...
                else if (mode == MODE_ASSETS)
                {
                    ...
                    if (mouseState == STATE_CTRL_DRAGGING_ASSET)
                    {
                        ...
                        drawSquare(g2d, x, y, 5);
                        g2d.setColor(java.awt.Color.LIGHT_GRAY); // XXX dotted?
            ...
            public MyCanvas()
            {
                ...
                this.addMouseListener(new java.awt.event.MouseListener() {
                                ...
                                else if (indicesOfClosestThing[1] != -1)
                                {
                                    ...
                                    if (indexOf(connections[indicesOfClosestThing[1]][0], indexOfThingBeingDragged) == -1)
                                        connections[indicesOfClosestThing[1]][0] =
                                                (int[])append(connections[indicesOfClosestThing[1]][0], Integer.valueOf(indexOfThingBeingDragged));
                                    else
                            ...
                            else if (mouseState == STATE_CTRL_DRAGGING_EVENT)
                            {
                                ...
                                if (indicesOfClosestThing[0] != -1)
                                {
                                    ...
                                    if (indexOf(connections[indexOfThingBeingDragged][1], indicesOfClosestThing[0]) == -1)
                                        connections[indexOfThingBeingDragged][1] = (int[])append(connections[indexOfThingBeingDragged][1], Integer.valueOf(indicesOfClosestThing[0]));
                                    else
                    ...
                    public void mouseEntered(java.awt.event.MouseEvent e)
                    {
                        ...
                        canvas.requestFocus(); // XXX does this do anything? not sure
                        ...
                        switch(c)
                        {
                            ...
                            case 'n': // add a new asset
                                if (mode == MODE_ASSETS)
                                {
                                    ...
                                    nFramesUntilFutures = (int[])append(nFramesUntilFutures, Integer.valueOf(0));
        ...
        // XXX also this is apparently NOT an override
        ...
        public MyDemoPanel(boolean useSplitPane)
        {
            ...
            buttonRow1.setBackground(java.awt.Color.LIGHT_GRAY); // so it stands out
            javax.swing.JPanel buttonRow2 = new javax.swing.JPanel();
            buttonRow2.setBackground(java.awt.Color.LIGHT_GRAY); // so it stands out

            // In 1.3 we could just say new JButton(new AbstractAction("+"){...}) but in 1.2 we have to call addActionListener instead
            buttonRow1.add(new javax.swing.JButton("+") {{
                addActionListener(new javax.swing.AbstractAction() {
            ...
            buttonRow1.add(autoCleanCheckBox = new javax.swing.JCheckBox("Auto Clean") {{
                addActionListener(new javax.swing.AbstractAction() {
                    @Override public void actionPerformed(java.awt.event.ActionEvent e)
                    {
        ...
        static final String helpMessage[] = {
            ...
            "            T -- increase white shadow thickness",
            "            t -- decrease white shadow thickness",
        ...
        private static int[] getSortedInds(final double A[])
        {
            ...
            for (int i = 0; i < n; ++i)
                Inds[i] = Integer.valueOf(i);
            java.util.Arrays.sort(Inds, new java.util.Comparator<Integer>()
            {
                @Override public int compare(Integer aObj, Integer bObj)
                {
                    int a = aObj.intValue();
                    int b = bObj.intValue();
                    return A[a] < A[b] ? -1 :
                                      ...
                                      boolean assetsShouldTakePrecedenceIfFound)
        {
            ...
            {
                do { if (!(curves != null)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrows.prejava"+"("+2381 +"): " + "curves != null" + ""); } while (false);
        ...
        private void recalculateCurves()
        {
            ...
            for (int i = 0; i < connections.length; ++i)
            {
                ...
                do { if (!(connectionCurves[i] != null)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrows.prejava"+"("+2499 +"): " + "connectionCurves[i] != null" + ""); } while (false);
            }
        } // calculateCurves
        ...
        public static void appendArrayToString(Object array, StringBuilder sb)
        {
            if (array == null)
                sb.append("null");
