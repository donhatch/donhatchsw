...
// !!! THIS FILE WAS AUTOMATICALLY GENERATED BY javacpp; DO NOT EDIT !!!
// !!! THIS FILE WAS AUTOMATICALLY GENERATED BY javacpp; DO NOT EDIT !!!
// 102 # 1 "com/donhatchsw/util/Listenable.prejava"
// 103 # 1 "<built-in>"
// 104 # 1 "<command-line>"
...
// 150 # 1 "com/donhatchsw/util/Listenable.prejava"

// 152 # 1 "com/donhatchsw/util/Listenable.prejava"
...
// XXX ... what a mess
// 166 # 4 "com/donhatchsw/util/Listenable.prejava" 2
...
public abstract class Listenable
{
        ...
        synchronized(listeners) // XXX this should be a read-only synchronization that allows multiple readers to run simultaneously, if I can figure out how to do that.  actually if I do that, need to change to full synchronization if it looks like we have to modify it.  copy-on-write?
        {
            ...
            if (lastCaught != null)
            {
                ...
                if (lastCaught instanceof RuntimeException)
                    ...
                    do { if (!(false)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Listenable.prejava"+"("+144 +"): " + "false" + ""); } while (false); // all unchecked exceptions are RuntimeError or Error, this shouldn't happen
            }
        }
    ...
    public static class Int extends Number
    {
        ...
        {
            set(((((value-minValue) + inc)%(maxValue+1-minValue)+(maxValue+1-minValue))%(maxValue+1-minValue)) + minValue);
        }
