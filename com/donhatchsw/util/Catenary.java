...
// !!! THIS FILE WAS AUTOMATICALLY GENERATED BY javacpp; DO NOT EDIT !!!
// !!! THIS FILE WAS AUTOMATICALLY GENERATED BY javacpp; DO NOT EDIT !!!
// 102 # 1 "com/donhatchsw/util/Catenary.prejava"
// 103 # 1 "<built-in>"
// 104 # 1 "<command-line>"
...
// 150 # 1 "com/donhatchsw/util/Catenary.prejava"

// 152 # 1 "com/donhatchsw/util/Catenary.prejava"
...
// XXX ... what a mess
// 166 # 4 "com/donhatchsw/util/Catenary.prejava" 2
...
public class Catenary
{
    ...
    public double sNumerator = Double.NaN;
    public double sDenominator = Double.NaN;

    // Value at t=0.  Must be finite.
    public double xFocusInWorld = Double.NaN;
    public double yFocusInWorld = Double.NaN;

    // Unit direction vector of the tangent of the function at the focus point.
    public double xFocusDirection = Double.NaN;
    public double yFocusDirection = Double.NaN;

    // t's for which value is x0,y0 and x1,y1 if fitting to sample points
    ...
    public void assertValid()
    {
        try
        {
            do { if (!((sNumerator)>=(0.))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+87 +"): (" + "sNumerator" + ")" + ">=" + "(" + "0." + ") ("+(sNumerator)+" vs. "+(0.)+")"); } while (false);
            do { if (!((sDenominator)>=(0.))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+88 +"): (" + "sDenominator" + ")" + ">=" + "(" + "0." + ") ("+(sDenominator)+" vs. "+(0.)+")"); } while (false);
            do { if (!((Math.max(sNumerator, sDenominator))==(1.))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+89 +"): (" + "Math.max(sNumerator, sDenominator)" + ")" + "==" + "(" + "1." + ") ("+(Math.max(sNumerator, sDenominator))+" vs. "+(1.)+")"); } while (false);

            do { if (!((xFocusDirection)>=(0))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+91 +"): (" + "xFocusDirection" + ")" + ">=" + "(" + "0" + ") ("+(xFocusDirection)+" vs. "+(0)+")"); } while (false); // no restriction on sign of y
            ...
            do { if (!((((focusDirectionLengthError)*(focusDirectionLengthError)) + 1. - 1.)==(0.))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+96 +"): (" + "((focusDirectionLengthError)*(focusDirectionLengthError)) + 1. - 1." + ")" + "==" + "(" + "0." + ") ("+(((focusDirectionLengthError)*(focusDirectionLengthError)) + 1. - 1.)+" vs. "+(0.)+")"); } while (false); // implicit tolerance

            do { if (!((t0)<=(t1))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+98 +"): (" + "t0" + ")" + "<=" + "(" + "t1" + ") ("+(t0)+" vs. "+(t1)+")"); } while (false);
            do { if (!((t0)<=(0.))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+99 +"): (" + "t0" + ")" + "<=" + "(" + "0." + ") ("+(t0)+" vs. "+(0.)+")"); } while (false);
            do { if (!((t1)>=(0.))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+100 +"): (" + "t1" + ")" + ">=" + "(" + "0." + ") ("+(t1)+" vs. "+(0.)+")"); } while (false);
            ...
            if (t0 != 0. && t1 != 0.)
            {
                do { if (!((xFocusDirection)==(1.))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+107 +"): (" + "xFocusDirection" + ")" + "==" + "(" + "1." + ") ("+(xFocusDirection)+" vs. "+(1.)+")"); } while (false);
                do { if (!((yFocusDirection)==(0.))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+108 +"): (" + "yFocusDirection" + ")" + "==" + "(" + "0." + ") ("+(yFocusDirection)+" vs. "+(0.)+")"); } while (false);
            }
        }
        catch (Error e)
        {
                    ...
                    int verboseLevel) // 0: nothing, 1: in/out, 2: more details
    {
        ...
        try
        {
            do { if (!(slack >= 0.)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+131 +"): " + "slack >= 0." + ""); } while (false); // precondition
            do { if (!(x0 <= x1)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+132 +"): " + "x0 <= x1" + ""); } while (false); // precondition
            double dx = x1 - x0;
            double dy = y1 - y0;
             ...
             || XXX_USE_SIMPLE_PROTECTION && slack <= tol)
            {
                ...
                // s is infinity
                //CHECK(false); // coverage; remove when hit
                this.sNumerator = 1.;
                this.sDenominator = 0.;
            ...
            else
            {
                ...
                double L2_minus_dy2 = ((dx)*(dx)) + slack*(2*dist + slack);
                do { if (!((L2_minus_dy2)==(L*L - dy*dy)||Math.abs((L2_minus_dy2)-(L*L - dy*dy))<=1e-6)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+218 +"): " +"(" + "L2_minus_dy2" + ")==(" + "L*L - dy*dy" + ")+-" + "1e-6" + "" +" ("+(L2_minus_dy2)+" vs. "+(L*L - dy*dy)+" +- "+(1e-6)+")" +" (error = "+((L2_minus_dy2)-(L*L - dy*dy))+")" ); } while (false);
                double sqrt_L2minusdy2 = Math.sqrt(L2_minus_dy2); // not used immediately, used farther down
                do { if (!((sqrt_L2minusdy2)>=(dx))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+220 +"): (" + "sqrt_L2minusdy2" + ")" + ">=" + "(" + "dx" + ") ("+(sqrt_L2minusdy2)+" vs. "+(dx)+")"); } while (false);
                ...
                */
                ...
                double sqrt_L2minusdy2__over_dx = Math.sqrt(1. + 2.*slack*MyMath.hypot(1.,dy/dx)/dx + ((slack/dx)*(slack/dx)));
                ...
                if (slack >= 1e-3)
                {
                    ...
                    {
                        // absolute tolerance
                        do { if (!((sqrt_L2minusdy2__over_dx)==(sqrt_L2minusdy2__over_dx___naive)||Math.abs((sqrt_L2minusdy2__over_dx)-(sqrt_L2minusdy2__over_dx___naive))<=1e-3)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+254 +"): " +"(" + "sqrt_L2minusdy2__over_dx" + ")==(" + "sqrt_L2minusdy2__over_dx___naive" + ")+-" + "1e-3" + "" +" ("+(sqrt_L2minusdy2__over_dx)+" vs. "+(sqrt_L2minusdy2__over_dx___naive)+" +- "+(1e-3)+")" +" (error = "+((sqrt_L2minusdy2__over_dx)-(sqrt_L2minusdy2__over_dx___naive))+")" ); } while (false);
                    }
                    else
                    {
                        // relative tolerance
                        // (XXX SVVP demo3 gets values on order of 3e13 here-- maybe that's a problem?)
                        do { if (!((sqrt_L2minusdy2__over_dx/sqrt_L2minusdy2__over_dx___naive)==(1.)||Math.abs((sqrt_L2minusdy2__over_dx/sqrt_L2minusdy2__over_dx___naive)-(1.))<=1e-3)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+260 +"): " +"(" + "sqrt_L2minusdy2__over_dx/sqrt_L2minusdy2__over_dx___naive" + ")==(" + "1." + ")+-" + "1e-3" + "" +" ("+(sqrt_L2minusdy2__over_dx/sqrt_L2minusdy2__over_dx___naive)+" vs. "+(1.)+" +- "+(1e-3)+")" +" (error = "+((sqrt_L2minusdy2__over_dx/sqrt_L2minusdy2__over_dx___naive)-(1.))+")" ); } while (false);
                    }
                }
                ...
                if (sDenominator == 0.)
                {
                    ...
                    // (so slack was pretty small but wasn't zero).
                    // don't descend into further complication;
                    // do the same thing we did with slack=0.
                    // TODO: this is really a cop-out; should be using math that doesn't degenerate and doesn't make this a special case.
                    do { if (!((dist)!=(0.))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+286 +"): (" + "dist" + ")" + "!=" + "(" + "0." + ") ("+(dist)+" vs. "+(0.)+")"); } while (false); // dist=0 should have been covered by dx=0 case
                    this.xFocusDirection = dx / dist;
                    this.yFocusDirection = dy / dist;
                    ...
                    if (y0 <= y1)
                    {
                        ...
                        this.yFocusInWorld = y0;
                        this.t0 = 0.;
                        this.t1 = dist; // = L but maybe not exactly
                    }
                    else
                    {
                        this.xFocusInWorld = x1;
                        this.yFocusInWorld = y1;
                        this.t0 = -dist; // = -L but maybe not exactly
                        this.t1 = 0.;
                    }
                }
                else
                {
                    ...
                    if (this.t0 > 0. || this.t1 < 0.)
                    {
                        ...
                        do { if (!((temp)!=(0.))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+362 +"): (" + "temp" + ")" + "!=" + "(" + "0." + ") ("+(temp)+" vs. "+(0.)+")"); } while (false);
                              ...
                              double answer[/*2*/])
    {
        ...
        if (answer[0] == 0. && answer[1] == 0.)
        {
            ...
            do { if (!(false)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+424 +"): " + "false" + ""); } while (false); // coverage; remove when hit.  (it is hit once in a blue moon in SmoothlyVaryingViewingParameter demo3, currently)
            answer[0] = 1.;
        }
        VecMath.normalize(answer, answer);

        do { if (!(answer[0] >= 0.)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+429 +"): " + "answer[0] >= 0." + ""); } while (false);
                         ...
                         double answer[/*2*/])
    {
        ...
        else
        {
            ...
            if (((TFocus_times_s_numerator)*(TFocus_times_s_numerator)) <= ((TFocus_times_s_denominator)*(TFocus_times_s_denominator))) // XXX?
            {
                          ...
                          double answer[/*2*/])
    {
        ...
        else
        {
            ...
            do { if (!(xFocusDirection != 0.)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+564 +"): " + "xFocusDirection != 0." + ""); } while (false);
    ...
    public static void confidenceTest()
    {
        ...
        if (true)
        {
            ...
            for (int iInput = 0; iInput < inputs.length; ++iInput)
            {
                ...
                do { if (!(("x0="+x0+", y0="+y0+", x1="+x1+", y1="+y1+", slack="+slack).equals(inputs[iInput]))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+885 +"): " + "(\"x0=\"+x0+\", y0=\"+y0+\", x1=\"+x1+\", y1=\"+y1+\", slack=\"+slack).equals(inputs[iInput])" + ""); } while (false);
                ...
                {System.out.print("        "); System.out.println("catenary" + " = " + (catenary));};
            }
            ...
            for (int iDelta = 0; iDelta < deltas.length; ++iDelta)
            {
                ...
                for (int iScale = 0; iScale < scales.length; ++iScale)
                {
                    ...
                    for (int iIntervalSize = 0; iIntervalSize < intervalSizesOnCanonical.length; ++iIntervalSize)
                    {
                        ...
                        double incr = ((intervalSizeOnCanonical)>=(.1)?(intervalSizeOnCanonical):(.1));
                        {System.out.print("        "); System.out.println("incr" + " = " + (incr));};
                             ...
                             X0 += .5*incr)
                        {
                            ...
                            double T = ((1-(1./3.))*(T0) + (1./3.)*(T1)); // arbitrary sample point 1/3 of the way from start to end
                            ...
                            double Slack = ((2*MyMath.coshm1(intervalSizeOnCanonical)
                                           - ((intervalSizeOnCanonical)*(intervalSizeOnCanonical))))
                            ...
                            {System.out.print("        "); System.out.println("SlackNaive" + " = " + (SlackNaive));};
                            {System.out.print("        "); System.out.println("Slack+0000" + " = " + (Slack+0000));}; // pad to line up

                            System.out.println("        " + "delta" + " = " + VecMath.toString(delta));
                            {System.out.print("        "); System.out.println("s" + " = " + (s));};
                            {System.out.print("        "); System.out.println("intervalSizeOnCanonical" + " = " + (intervalSizeOnCanonical));};
                            ...
                            {System.out.print("        "); System.out.println("T0" + " = " + (T0));};
                            {System.out.print("        "); System.out.println("T1" + " = " + (T1));};
                            {System.out.print("        "); System.out.println("Slack" + " = " + (Slack));};
                            {System.out.print("        "); System.out.println("T" + " = " + (T));};
                            {System.out.print("        "); System.out.println("X" + " = " + (X));};
                            {System.out.print("        "); System.out.println("Y" + " = " + (Y));};
                            ...
                            catenary.fit(x0,y0,
                                         ...
                                         fitVerboseLevel);
                            {System.out.print("        "); System.out.println("catenary" + " = " + (catenary));};
                            double t = ((1-(1./3.))*(catenary.t0) + (1./3.)*(catenary.t1));
                            //double tol = 1e-12;
                            ...
                            if (true)
                            {
                                ...
                                //PRINTVEC(evaluated);
                                do { if (!((evaluated[0])==(x0)||Math.abs((evaluated[0])-(x0))<=tol)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+1027 +"): " +"(" + "evaluated[0]" + ")==(" + "x0" + ")+-" + "tol" + "" +" ("+(evaluated[0])+" vs. "+(x0)+" +- "+(tol)+")" +" (error = "+((evaluated[0])-(x0))+")" ); } while (false);
                                do { if (!((evaluated[1])==(y0)||Math.abs((evaluated[1])-(y0))<=tol)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+1028 +"): " +"(" + "evaluated[1]" + ")==(" + "y0" + ")+-" + "tol" + "" +" ("+(evaluated[1])+" vs. "+(y0)+" +- "+(tol)+")" +" (error = "+((evaluated[1])-(y0))+")" ); } while (false);

                                catenary.evaluate(catenary.t1, evaluated);
                                //PRINTVEC(evaluated);
                                do { if (!((evaluated[0])==(x1)||Math.abs((evaluated[0])-(x1))<=tol)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+1032 +"): " +"(" + "evaluated[0]" + ")==(" + "x1" + ")+-" + "tol" + "" +" ("+(evaluated[0])+" vs. "+(x1)+" +- "+(tol)+")" +" (error = "+((evaluated[0])-(x1))+")" ); } while (false);
                                do { if (!((evaluated[1])==(y1)||Math.abs((evaluated[1])-(y1))<=tol)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+1033 +"): " +"(" + "evaluated[1]" + ")==(" + "y1" + ")+-" + "tol" + "" +" ("+(evaluated[1])+" vs. "+(y1)+" +- "+(tol)+")" +" (error = "+((evaluated[1])-(y1))+")" ); } while (false);

                                catenary.evaluate(t, evaluated);
                                //PRINTVEC(evaluated);
                                do { if (!((evaluated[0])==(x)||Math.abs((evaluated[0])-(x))<=tol)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+1037 +"): " +"(" + "evaluated[0]" + ")==(" + "x" + ")+-" + "tol" + "" +" ("+(evaluated[0])+" vs. "+(x)+" +- "+(tol)+")" +" (error = "+((evaluated[0])-(x))+")" ); } while (false);
                                do { if (!((evaluated[1])==(y)||Math.abs((evaluated[1])-(y))<=tol)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+1038 +"): " +"(" + "evaluated[1]" + ")==(" + "y" + ")+-" + "tol" + "" +" ("+(evaluated[1])+" vs. "+(y)+" +- "+(tol)+")" +" (error = "+((evaluated[1])-(y))+")" ); } while (false);
                            }
                            ...
                            if (true)
                            {
                                ...
                                do { if (!((VecMath.norm(derivative))==(1.)||Math.abs((VecMath.norm(derivative))-(1.))<=tol)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+1054 +"): " +"(" + "VecMath.norm(derivative)" + ")==(" + "1." + ")+-" + "tol" + "" +" ("+(VecMath.norm(derivative))+" vs. "+(1.)+" +- "+(tol)+")" +" (error = "+((VecMath.norm(derivative))-(1.))+")" ); } while (false);
                                do { if (!((derivative[0])==(1./Y0)||Math.abs((derivative[0])-(1./Y0))<=tol)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+1055 +"): " +"(" + "derivative[0]" + ")==(" + "1./Y0" + ")+-" + "tol" + "" +" ("+(derivative[0])+" vs. "+(1./Y0)+" +- "+(tol)+")" +" (error = "+((derivative[0])-(1./Y0))+")" ); } while (false);
                                do { if (!((derivative[1])==(T0/Y0)||Math.abs((derivative[1])-(T0/Y0))<=tol)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+1056 +"): " +"(" + "derivative[1]" + ")==(" + "T0/Y0" + ")+-" + "tol" + "" +" ("+(derivative[1])+" vs. "+(T0/Y0)+" +- "+(tol)+")" +" (error = "+((derivative[1])-(T0/Y0))+")" ); } while (false);

                                catenary.differentiate(catenary.t1, derivative);
                                do { if (!((VecMath.norm(derivative))==(1.)||Math.abs((VecMath.norm(derivative))-(1.))<=tol)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+1059 +"): " +"(" + "VecMath.norm(derivative)" + ")==(" + "1." + ")+-" + "tol" + "" +" ("+(VecMath.norm(derivative))+" vs. "+(1.)+" +- "+(tol)+")" +" (error = "+((VecMath.norm(derivative))-(1.))+")" ); } while (false);
                                do { if (!((derivative[0])==(1./Y1)||Math.abs((derivative[0])-(1./Y1))<=tol)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+1060 +"): " +"(" + "derivative[0]" + ")==(" + "1./Y1" + ")+-" + "tol" + "" +" ("+(derivative[0])+" vs. "+(1./Y1)+" +- "+(tol)+")" +" (error = "+((derivative[0])-(1./Y1))+")" ); } while (false);
                                do { if (!((derivative[1])==(T1/Y1)||Math.abs((derivative[1])-(T1/Y1))<=tol)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+1061 +"): " +"(" + "derivative[1]" + ")==(" + "T1/Y1" + ")+-" + "tol" + "" +" ("+(derivative[1])+" vs. "+(T1/Y1)+" +- "+(tol)+")" +" (error = "+((derivative[1])-(T1/Y1))+")" ); } while (false);

                                catenary.differentiate(t, derivative);
                                do { if (!((VecMath.norm(derivative))==(1.)||Math.abs((VecMath.norm(derivative))-(1.))<=tol)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+1064 +"): " +"(" + "VecMath.norm(derivative)" + ")==(" + "1." + ")+-" + "tol" + "" +" ("+(VecMath.norm(derivative))+" vs. "+(1.)+" +- "+(tol)+")" +" (error = "+((VecMath.norm(derivative))-(1.))+")" ); } while (false);
                                do { if (!((derivative[0])==(1./Y)||Math.abs((derivative[0])-(1./Y))<=tol)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+1065 +"): " +"(" + "derivative[0]" + ")==(" + "1./Y" + ")+-" + "tol" + "" +" ("+(derivative[0])+" vs. "+(1./Y)+" +- "+(tol)+")" +" (error = "+((derivative[0])-(1./Y))+")" ); } while (false);
                                do { if (!((derivative[1])==(T/Y)||Math.abs((derivative[1])-(T/Y))<=tol)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+1066 +"): " +"(" + "derivative[1]" + ")==(" + "T/Y" + ")+-" + "tol" + "" +" ("+(derivative[1])+" vs. "+(T/Y)+" +- "+(tol)+")" +" (error = "+((derivative[1])-(T/Y))+")" ); } while (false);
                            }
                            ...
                            if (true)
                            {
                                ...
                                System.out.println("        " + "integral" + " = " + VecMath.toString(integral));
                                do { if (!((integral[0])==(0.))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+1087 +"): (" + "integral[0]" + ")" + "==" + "(" + "0." + ") ("+(integral[0])+" vs. "+(0.)+")"); } while (false);
                                do { if (!((integral[1])==(0.))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+1088 +"): (" + "integral[1]" + ")" + "==" + "(" + "0." + ") ("+(integral[1])+" vs. "+(0.)+")"); } while (false);

                                catenary.integrate(catenary.t0, catenary.t1, integral);
                                System.out.println("        " + "integral" + " = " + VecMath.toString(integral));
                                do { if (!((integral[0])==(s*(s*T1*X1 - s*Y1) - s*(s*T0*X0 - s*Y0) + (catenary.t1-catenary.t0)*xDelta)||Math.abs((integral[0])-(s*(s*T1*X1 - s*Y1) - s*(s*T0*X0 - s*Y0) + (catenary.t1-catenary.t0)*xDelta))<=tol)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+1092 +"): " +"(" + "integral[0]" + ")==(" + "s*(s*T1*X1 - s*Y1) - s*(s*T0*X0 - s*Y0) + (catenary.t1-catenary.t0)*xDelta" + ")+-" + "tol" + "" +" ("+(integral[0])+" vs. "+(s*(s*T1*X1 - s*Y1) - s*(s*T0*X0 - s*Y0) + (catenary.t1-catenary.t0)*xDelta)+" +- "+(tol)+")" +" (error = "+((integral[0])-(s*(s*T1*X1 - s*Y1) - s*(s*T0*X0 - s*Y0) + (catenary.t1-catenary.t0)*xDelta))+")" ); } while (false)

                                                                                                   ;
                                do { if (!((integral[1])==(.5*(s*T1*s*Y1 + s*s*Math.log(s*Y1+s*T1)) - .5*(s*T0*s*Y0 + s*s*Math.log(s*Y0+s*T0)) + (catenary.t1-catenary.t0)*yDelta)||Math.abs((integral[1])-(.5*(s*T1*s*Y1 + s*s*Math.log(s*Y1+s*T1)) - .5*(s*T0*s*Y0 + s*s*Math.log(s*Y0+s*T0)) + (catenary.t1-catenary.t0)*yDelta))<=tol)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+1095 +"): " +"(" + "integral[1]" + ")==(" + ".5*(s*T1*s*Y1 + s*s*Math.log(s*Y1+s*T1)) - .5*(s*T0*s*Y0 + s*s*Math.log(s*Y0+s*T0)) + (catenary.t1-catenary.t0)*yDelta" + ")+-" + "tol" + "" +" ("+(integral[1])+" vs. "+(.5*(s*T1*s*Y1 + s*s*Math.log(s*Y1+s*T1)) - .5*(s*T0*s*Y0 + s*s*Math.log(s*Y0+s*T0)) + (catenary.t1-catenary.t0)*yDelta)+" +- "+(tol)+")" +" (error = "+((integral[1])-(.5*(s*T1*s*Y1 + s*s*Math.log(s*Y1+s*T1)) - .5*(s*T0*s*Y0 + s*s*Math.log(s*Y0+s*T0)) + (catenary.t1-catenary.t0)*yDelta))+")" ); } while (false)

                                                                                                   ;

                                catenary.integrate(catenary.t0, t, integral);
                                System.out.println("        " + "integral" + " = " + VecMath.toString(integral));
                                do { if (!((integral[0])==(s*(s*T*X - s*Y) - s*(s*T0*X0 - s*Y0) + (t-catenary.t0)*xDelta)||Math.abs((integral[0])-(s*(s*T*X - s*Y) - s*(s*T0*X0 - s*Y0) + (t-catenary.t0)*xDelta))<=tol)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+1101 +"): " +"(" + "integral[0]" + ")==(" + "s*(s*T*X - s*Y) - s*(s*T0*X0 - s*Y0) + (t-catenary.t0)*xDelta" + ")+-" + "tol" + "" +" ("+(integral[0])+" vs. "+(s*(s*T*X - s*Y) - s*(s*T0*X0 - s*Y0) + (t-catenary.t0)*xDelta)+" +- "+(tol)+")" +" (error = "+((integral[0])-(s*(s*T*X - s*Y) - s*(s*T0*X0 - s*Y0) + (t-catenary.t0)*xDelta))+")" ); } while (false)

                                                                                         ;
                                do { if (!((integral[1])==(.5*(s*T*s*Y + s*s*Math.log(s*Y+s*T)) - .5*(s*T0*s*Y0 + s*s*Math.log(s*Y0+s*T0)) + (t-catenary.t0)*yDelta)||Math.abs((integral[1])-(.5*(s*T*s*Y + s*s*Math.log(s*Y+s*T)) - .5*(s*T0*s*Y0 + s*s*Math.log(s*Y0+s*T0)) + (t-catenary.t0)*yDelta))<=tol)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Catenary.prejava"+"("+1104 +"): " +"(" + "integral[1]" + ")==(" + ".5*(s*T*s*Y + s*s*Math.log(s*Y+s*T)) - .5*(s*T0*s*Y0 + s*s*Math.log(s*Y0+s*T0)) + (t-catenary.t0)*yDelta" + ")+-" + "tol" + "" +" ("+(integral[1])+" vs. "+(.5*(s*T*s*Y + s*s*Math.log(s*Y+s*T)) - .5*(s*T0*s*Y0 + s*s*Math.log(s*Y0+s*T0)) + (t-catenary.t0)*yDelta)+" +- "+(tol)+")" +" (error = "+((integral[1])-(.5*(s*T*s*Y + s*s*Math.log(s*Y+s*T)) - .5*(s*T0*s*Y0 + s*s*Math.log(s*Y0+s*T0)) + (t-catenary.t0)*yDelta))+")" ); } while (false)
        ...
        {
            System.out.println("WARNING: general testing disabled");
        }
