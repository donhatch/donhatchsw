...
// !!! THIS FILE WAS AUTOMATICALLY GENERATED BY javacpp; DO NOT EDIT !!!
// !!! THIS FILE WAS AUTOMATICALLY GENERATED BY javacpp; DO NOT EDIT !!!
// 102 # 1 "com/donhatchsw/util/UndoTreeViewer.prejava"
// 103 # 1 "<built-in>"
// 104 # 1 "<command-line>"
...
// 150 # 1 "com/donhatchsw/util/UndoTreeViewer.prejava"

// 152 # 1 "com/donhatchsw/util/UndoTreeViewer.prejava"
...
*/
// XXX would it make more sense for the UndoTreeViewer to call undo/redo etc. on the UndoTree directly, and have the Application be set up to intercept those somehow?  Think about that...
public class UndoTreeViewer
{
    ...
    */
    ...
    private UndoTreeSquirrel.ItemLengthizer lengthizer; // set in ctor
    ...
    //
        ...
        private double followerBounce = .1; // just detectable if you're paying attention
    ...
    // Things I listen to...
    //
    private UndoTreeSquirrel undoTreeSquirrel = null;
    private UndoTreeSquirrel.Listener undoTreeListener = null;
    private UndoTreeSquirrel undoTreeSquirrel2 = null; // XXX lame, should be a list
    private UndoTreeSquirrel.Listener undoTreeListener2 = null; // XXX lame, should be a list
    ...
    /** Install one of these if you want the UndoTreeSquirrel to be able to request app actions in response to the user manipulating the UndoTreeViewer window. */
    ...
    /** Attaches to the given UndoTreeSquirrel. It is an error to try to attach to more than one UndoTreeSquirrel at a given time. */
    public void attachToUndoTreeSquirrel(UndoTreeSquirrel undoTreeSquirrel)
    {
        if (undoTreeListener != null)
            throw new IllegalArgumentException("UndoTreeViewer.attachToUndoTreeSquirrel: already attached to someone"); // XXX should be illegal state or something instead?
        this.undoTreeSquirrel = undoTreeSquirrel;
        undoTreeSquirrel.addListener(this.undoTreeListener = new UndoTreeSquirrel.Listener() {
    ...
    } // attachToUndoTreeSquirrel
    public void attachToUndoTreeSquirrel2(UndoTreeSquirrel undoTreeSquirrel2)
    {
        if (undoTreeListener2 != null)
            throw new IllegalArgumentException("UndoTreeViewer.attachToUndoTreeSquirrel2: already attached to someone"); // XXX should be illegal state or something instead?
        this.undoTreeSquirrel2 = undoTreeSquirrel2;
        undoTreeSquirrel2.addListener(this.undoTreeListener2 = new UndoTreeSquirrel.Listener() {
            public void somethingChanged()
            {
                if (component != null)
                    component.repaint();
    ...
    /** Detaches from the UndoTreeSquirrel that was previously attached using attachToUndoTreeSquirrel. */
    public void detachFromUndoTreeSquirrel()
    {
        if (undoTreeListener == null)
            throw new IllegalArgumentException("UndoTreeViewer.detachFromUndoTreeSquirrel: not attached to any UndoTreeSquirrel"); // XXX should be illegal state or something instead?
        undoTreeSquirrel.removeListener(undoTreeListener);
        undoTreeListener = null;
        undoTreeSquirrel = null;

        // And just do it, since something did change...
        if (component != null)
            component.repaint();
    } // detachFromUndoTreeSquirrel

    public void detachFromUndoTreeSquirrel2()
    {
        if (undoTreeListener2 == null)
            throw new IllegalArgumentException("UndoTreeViewer.detachFromUndoTreeSquirrel: not attached to any UndoTreeSquirrel"); // XXX should be illegal state or something instead?
        undoTreeSquirrel2.removeListener(undoTreeListener);
        undoTreeListener2 = null;
        undoTreeSquirrel2 = null;

        // And just do it, since something did change...
        if (component != null)
            component.repaint();
    } // detachFromUndoTreeSquirrel2
    ...
    public void attachToComponent(final java.awt.Component component)
    {
        ...
        component.addKeyListener(componentKeyListener = new java.awt.event.KeyListener() {
            ...
            public void keyPressed(java.awt.event.KeyEvent ke)
            {
                ...
                if (false)
                {
                    ...
                    {System.out.print("        "); System.out.println("keyCode" + " = " + (keyCode));};
                    {System.out.print("        "); System.out.println("keyChar" + " = " + (keyChar));};
                    {System.out.print("        "); System.out.println("keyText" + " = " + (keyText));};
                    {System.out.print("        "); System.out.println("java.awt.event.KeyEvent.VK_NUMPAD0" + " = " + (java.awt.event.KeyEvent.VK_NUMPAD0));};
                    {System.out.print("        "); System.out.println("java.awt.event.KeyEvent.VK_NUMPAD1" + " = " + (java.awt.event.KeyEvent.VK_NUMPAD1));};
                    {System.out.print("        "); System.out.println("java.awt.event.KeyEvent.VK_NUMPAD2" + " = " + (java.awt.event.KeyEvent.VK_NUMPAD2));};
                    {System.out.print("        "); System.out.println("java.awt.event.KeyEvent.VK_NUMPAD3" + " = " + (java.awt.event.KeyEvent.VK_NUMPAD3));};
                    {System.out.print("        "); System.out.println("java.awt.event.KeyEvent.VK_NUMPAD4" + " = " + (java.awt.event.KeyEvent.VK_NUMPAD4));};
                    {System.out.print("        "); System.out.println("java.awt.event.KeyEvent.VK_NUMPAD5" + " = " + (java.awt.event.KeyEvent.VK_NUMPAD5));};
                    {System.out.print("        "); System.out.println("java.awt.event.KeyEvent.VK_NUMPAD6" + " = " + (java.awt.event.KeyEvent.VK_NUMPAD6));};
                    {System.out.print("        "); System.out.println("java.awt.event.KeyEvent.VK_NUMPAD7" + " = " + (java.awt.event.KeyEvent.VK_NUMPAD7));};
                    {System.out.print("        "); System.out.println("java.awt.event.KeyEvent.VK_NUMPAD8" + " = " + (java.awt.event.KeyEvent.VK_NUMPAD8));};
                    {System.out.print("        "); System.out.println("java.awt.event.KeyEvent.VK_NUMPAD9" + " = " + (java.awt.event.KeyEvent.VK_NUMPAD9));};
                }
            ...
            public void keyTyped(java.awt.event.KeyEvent ke)
            {
                ...
                if (c == '0') // toggle center current node
                {
                    ...
                    centerCurrentNode.setTargetPosition(1.-centerCurrentNode.getTargetPosition());
                }
                else if (c == '+' || c == '=') // zoom in
                {
                    boolean justUseLerp = (ke.isShiftDown());
                    log2ViewScale.setTargetPosition(log2ViewScale.getTargetPosition() + .5f);
                }
                else if (c == '-') // zoom out
                {
                    boolean justUseLerp = (ke.isShiftDown());
                ...
                {
                    boolean justUseLerp = (ke.isShiftDown());
                    stretchOutAlongTimeLine.setTargetPosition(1.-stretchOutAlongTimeLine.getTargetPosition());
                }
                else if (c == 'a') // ascii dump
                {
                    asciiDump(undoTreeSquirrel, stretchOutAlongTimeLine.get());
                }
                else if (c == 'S')
                {
                ...
                {
                    undoTreeSquirrel.setSharedLabel("this_is_a_shared_label"); // XXX get rid of the underscores when I make the parsing smarter
                }
                else if (c == 'p') // set private label
                {
                    undoTreeSquirrel.setPrivateLabel("this_is_a_private_label"); // XXX get rid of the underscores when I make the parsing smarter
                }
                */
        ...
        component.addMouseListener(componentMouseListener = new java.awt.event.MouseListener() {
            ...
            public void mousePressed(java.awt.event.MouseEvent me)
            {
                ...
                setCurrentToClosestToMouse(frameForPicking, me.getX(), me.getY(), undoTreeSquirrel);
        ...
        //
            ...
            private void requestYoungerBranch() // 7 key on numeric keypad
            {
                ...
                int nUndosDone = 0;
                while (undoTreeSquirrel.undo() != null)
                {
                    nUndosDone++;
                    if (undoTreeSquirrel.preferYoungerChild())
                    {
                        undoTreeSquirrel.redo();
                        return;
                    }
                }
            ...
            private void requestUndo(double amount) // 8 key on numeric keypad
            {
                ...
                do { if (!(amount >= 0)) throw new Error("CHECK failed at "+"com/donhatchsw/util/UndoTreeViewer.prejava"+"("+552 +"): " + "amount >= 0" + ""); } while (false);

                double originalFraction = undoTreeSquirrel.getCurrentNodeFraction();
                ...
                if (originalFraction > 0.
                 && targetFraction <= 0.)
                {
                    Object undoneItem = undoTreeSquirrel.undo();
                    if (eventVerboseLevel >= 1) System.out.println("undid "+(String)undoneItem);
                    undoTreeSquirrel.setCurrentNodeFraction(1.);
                }
                else
                {
                    undoTreeSquirrel.setCurrentNodeFraction(targetFraction);
                }
            }
            private void requestOlderBranch() // 9 key on numeric keypad
            {
                ...
                {
                    nUndosDone++;
                    if (undoTreeSquirrel.preferOlderChild())
                    {
                        undoTreeSquirrel.redo();
                        return;
                    }
            ...
            private void requestOlder() // 4 key on numeric keypad
            {
                ...
                while (undoTreeSquirrel.undo() != null)
                {
                    ...
                    if (undoTreeSquirrel.preferOlderChild())
                    {
                        ...
                        while (nUndosDone-- > 0)
                        {
                            undoTreeSquirrel.redo(); // okay if fails
                            if (nUndosDone > 0)
                            {
                                while (undoTreeSquirrel.preferYoungerChild())
                                    ;
                            }
                        }
                        return;
                ...
                while (undoTreeSquirrel.undo() != null)
                {
                    ...
                    if (undoTreeSquirrel.preferYoungerChild())
                    {
                        ...
                        while (nUndosDone-- > 0)
                        {
                            ...
                            if (nUndosDone > 0)
                            {
                                while (undoTreeSquirrel.preferOlderChild())
                                    ;
                            }
                        }
                        return;
            ...
            private void requestOlderLeaf() // 7 key on numeric keypad
            {
                ...
                while (undoTreeSquirrel.undo() != null)
                {
                    ...
                    if (undoTreeSquirrel.preferOlderChild())
                    {
                        ...
                        // sticking to the young side
                        while (undoTreeSquirrel.redo() != null)
                        {
                            while (undoTreeSquirrel.preferYoungerChild())
                                ;
                        }
            ...
            private void requestRedo(double amount) // 8 key on numeric keypad
            {
                ...
                do { if (!(amount >= 0)) throw new Error("CHECK failed at "+"com/donhatchsw/util/UndoTreeViewer.prejava"+"("+670 +"): " + "amount >= 0" + ""); } while (false);
                ...
                double tol = 1e-3;
                if ((((1.)-(originalFraction)) > (tol))
                 && (((targetFraction)-(1.)) > (tol)))
                {
                    targetFraction = 1.;
                }
                else if (((((originalFraction)-(1.)) <= (tol)) && (((1.)-(originalFraction)) <= (tol)))
                      && (((targetFraction)-(1.)) > (tol)))
                {
                    Object redoneItem = undoTreeSquirrel.redo();
            ...
            private static void setCurrentToClosestToMouse(double frameForPicking[][], int mouseX, int mouseY, UndoTreeSquirrel undoTreeSquirrel)
            {
                if (frameForPicking != null)
                {
                    ...
                    {
                        double thisDistSqrd = ((mouseX-frameForPicking[0][iNode])*(mouseX-frameForPicking[0][iNode]))
                                            + ((mouseY-frameForPicking[1][iNode])*(mouseY-frameForPicking[1][iNode]));
                    ...
                    undoTreeSquirrel.setCurrentNodeIndex(closestNode);
                }
    ...
    // XXX should be in a different class
    //
        /**
    ...
    private UndoTreeSquirrel.Snapshot snapshot = new UndoTreeSquirrel.Snapshot(); // scratch to reuse each time  // XXX put this up top somewhere, and should probably clear it if the tree is cleared
    ...
    public void paint(java.awt.Component component, java.awt.Graphics g)
    {
        ...
        {
            stretchOutAlongTimeLine.evolve(1, paramFadeFrames, 1, paramBounce);
            ...
            centerCurrentNode.evolve(1, paramFadeFrames, 1, paramBounce);
            ...
            log2ViewScale.evolve(1, paramFadeFrames, 1, paramBounce);
        ...
        UndoTreeSquirrel otherSquirrels[] = undoTreeSquirrel2 != null ? new UndoTreeSquirrel[] {undoTreeSquirrel2} : new UndoTreeSquirrel[] {};

        undoTreeSquirrel.takeSnapshot(snapshot, otherSquirrels);
        ...
        UndoTreeSquirrel.chooseNodePositions(snapshot.nNodes,
                                             snapshot.parents,
        ...
        ymax += .5;
        {
            for (int iNode = 0; iNode < nNodes; ++iNode)
            {
                ...
                x[iNode] = ((1-(xFrac))*(0) + (xFrac)*(w));
                y[iNode] = ((1-(yFrac))*(20) + (yFrac)*(h)); // XXX hack- leave margin at top
            }
        }

        {
            // XXX lame arithmetic, should combine
            double currentNodeX = ((1-(currentNodeSpaceFraction))*(x[parentNode]) + (currentNodeSpaceFraction)*(x[snapshot.currentNode]));
            double currentNodeY = ((1-(currentNodeSpaceFraction))*(y[parentNode]) + (currentNodeSpaceFraction)*(y[snapshot.currentNode]));
            double translateX = ((1-(centerCurrentNode.get()))*(0) + (centerCurrentNode.get())*(w/2.-currentNodeX));
            double translateY = ((1-(centerCurrentNode.get()))*(0) + (centerCurrentNode.get())*(h/2.-currentNodeY));
            for (int iNode = 0; iNode < nNodes; ++iNode)
            {
                x[iNode] += translateX;
                y[iNode] += translateY;
        ...
        // Actual drawing starts here
        {
            ...
            //
            // Put smaller rings around any secondary squirrels' positions.
            //
            for (int i = 0; i < snapshot.nOtherSquirrels; ++i)
            {
                int parentNode2 = snapshot.parents[snapshot.otherSquirrelsCurrentNodes[i]]==-1 ? snapshot.otherSquirrelsCurrentNodes[i] : snapshot.parents[snapshot.otherSquirrelsCurrentNodes[i]];
                double currentNodeX = ((1-(snapshot.otherSquirrelsCurrentNodeFractions[i]))*(x[parentNode2]) + (snapshot.otherSquirrelsCurrentNodeFractions[i])*(x[snapshot.otherSquirrelsCurrentNodes[i]])); // assumes time = space
                double currentNodeY = ((1-(snapshot.otherSquirrelsCurrentNodeFractions[i]))*(y[parentNode2]) + (snapshot.otherSquirrelsCurrentNodeFractions[i])*(y[snapshot.otherSquirrelsCurrentNodes[i]])); // assumes time = space
                g.setColor(java.awt.Color.WHITE);
                int radius = 4;
                g.drawRect((int)currentNodeX-radius,
                           (int)currentNodeY-radius,
            ...
            ++nPaintsDone;
            drawString((java.awt.Graphics2D)g, "("+nPaintsDone+" paint"+(nPaintsDone==1?"":"s")+")", w-2, 2, 1, -1.);
        }
    } // paint
    private int nPaintsDone = 0;

    /** Creates an UndoTreeViewer.  Attach it to a Component using attachToComponent and to an UndoTreeSquirrel using attachToUndoTreeSquirrel. */
    ...
    private static void asciiDump(UndoTreeSquirrel undoTreeSquirrel, double stretchOutAlongTimeLine)
    {
        //PRINT(__LINE__);
        //PRINT(undoTreeSquirrel);
        ...
        if (undoTreeSquirrel != null)
        {
            UndoTreeSquirrel t0 = undoTreeSquirrel;
            String s1 = t0.toString(itemToString, indentSpaces, separatorSpaces);
            System.out.println(s1);

            if (true)
            {
                UndoTreeSquirrel t2 = UndoTreeSquirrel.fromString(s1, itemFromString);
            ...
            System.out.println("===================================");
            System.out.println(undoTreeSquirrel.toStringVisualCool(stretchOutAlongTimeLine >= .5f));
        }
        else
        {
    ...
    public static UndoTreeViewer makeExampleUndoTreeViewer(
                                           final String name,
                                           final UndoTreeSquirrel undoTreeSquirrel,
                                           final UndoTreeSquirrel otherSquirrels[],
                                           final String nameOfOtherViewThatThisViewShouldFollowAround,
                                           final UndoTreeSquirrel otherViewThatThisViewShouldFollowAround,
                                           ...
                                           final boolean allowClear,
                                           final UndoTreeSquirrel.ItemLengthizer lengthizer,
        ...
        final javax.swing.JPanel jpanel = new javax.swing.JPanel() {
            ...
            @Override public void paintComponent(java.awt.Graphics g)
            {
                ...
                if (isAFollower)
                {
                    ...
                    UndoTreeSquirrel.ReturnValueOfIncrementViewTowardsOtherView stateChange = undoTreeSquirrel.incrementViewTowardsOtherView(
                ...
                com.donhatchsw.compat.ArrayList stringsToDraw = new com.donhatchsw.compat.ArrayList(50);
                if (!isAFollower)
                {
                    if (allowUndoRedo)
                    {
                        if (allowDo)
                            stringsToDraw.add("Enter to Do");
                        stringsToDraw.add("  Up to undo");
                        stringsToDraw.add("  Down to redo");
                        stringsToDraw.add("  Left for older");
                        stringsToDraw.add("  Right for younger");
                        stringsToDraw.add("    (or just click and drag around)");
                        if (allowClear)
                            stringsToDraw.add("c to Clear");
                    }
                }
                else
                    stringsToDraw.add("S/s to follow Slower/faster");
                //stringsToDraw.add("  (or just click and drag around and hit enter a lot)");
                stringsToDraw.add("+/-/= to zoom in/out");
                stringsToDraw.add("0 to toggle keep-current-node-in-center mode");
                stringsToDraw.add("t to toggle stretch-out-along-time-line display mode");
                stringsToDraw.add("l to toggle labels");
                stringsToDraw.add("n for new view window of same tree");
                stringsToDraw.add("ctrl-n for new view that follows this view around like a dog");
                int nStringsToDraw = stringsToDraw.size();
                // XXX should use the font height instead of hard coding 20
                for (int i = 0; i < nStringsToDraw; ++i)
                    g.drawString((String)stringsToDraw.get(i),
                                 10, h-(nStringsToDraw-i)*20);

                if (undoTreeViewer.eventVerboseLevel >= 3) System.out.println("    out paintComponent");
            }
        };
        // should work in either order...
        // XXX need confidence test for it in both orders then
        undoTreeViewer.attachToComponent(jpanel);
        undoTreeViewer.attachToUndoTreeSquirrel(undoTreeSquirrel);
        for (int i = 0; i < otherSquirrels.length; ++i)
            undoTreeViewer.attachToUndoTreeSquirrel2(otherSquirrels[i]);


        // XXX hmm, I think I have listener memory leaks everywhere...
        // XXX this one in particular, no one is keeping track of it at all.
        // XXX in fact I don't think anyone ever calls detachFromUndoTreeSquirrel or detachFromComponent yet!
        {
            UndoTreeSquirrel.Listener otherViewThatThisViewShouldFollowAroundListener = null;
            final java.awt.Component component = jpanel;
            if (otherViewThatThisViewShouldFollowAround != null)
            {
                otherViewThatThisViewShouldFollowAround.addListener(otherViewThatThisViewShouldFollowAroundListener = new UndoTreeSquirrel.Listener() {
                    public void somethingChanged()
                    {
            ...
            public void keyPressed(java.awt.event.KeyEvent ke)
            {
                ...
                else if (keyCode == java.awt.event.KeyEvent.VK_N)
                {
                    makeExampleUndoTreeViewer("View "+(nViewsEverMade[0]++),
                                              new UndoTreeSquirrel(undoTreeSquirrel), // different view, same model
                                              new UndoTreeSquirrel[]{},
                                              ke.isControlDown() ? name : null, // ctrl-n means the new one should follow me around
                                              ke.isControlDown() ? undoTreeSquirrel : null, // ctrl-n means the new one should follow me around
                                              x+20, y+20, jframe.getWidth(), jframe.getHeight(), nThingsDoneEver, nViewersAlive, nModelsEverMade, nViewsEverMade, nViewersEverMade, allowDo, allowUndoRedo, allowClear, lengthizer, colorizer);
                }
    ...
    public static void main(String args[])
    {
        ...
        final UndoTreeSquirrel.ItemLengthizer lengthizer = new UndoTreeSquirrel.ItemLengthizer() {
        ...
        int x = 50;
        int w = 400;
        makeExampleUndoTreeViewer("View "+(nViewsEverMade[0]++), squirrel, new UndoTreeSquirrel[]{}, null, null, x, 20, w, 700, nThingsDoneEver, nViewersAlive, nModelsEverMade, nViewsEverMade, nViewersEverMade, true, true, true, lengthizer, colorizer);
        ...
        if (false)
        {
            ...
            makeExampleUndoTreeViewer("View "+(nViewsEverMade[0]++), squirrel, new UndoTreeSquirrel[]{}, null, null, x+=w, 20, w, 700, nThingsDoneEver, nViewersAlive, nModelsEverMade, nViewsEverMade, nViewersEverMade, true, true, true, lengthizer, colorizer);
        }
        if (false)
        {
            ...
            makeExampleUndoTreeViewer("View "+(nViewsEverMade[0]++), squirrel = new UndoTreeSquirrel(squirrel), new UndoTreeSquirrel[]{}, null, null, x+=w, 20, w, 700, nThingsDoneEver, nViewersAlive, nModelsEverMade, nViewsEverMade, nViewersEverMade, true, true, true, lengthizer, colorizer);
        }
        if (true)
        {
            // Doing it this way, the new one will follow the previous one
            // around!
            makeExampleUndoTreeViewer("View "+(nViewsEverMade[0]++), new UndoTreeSquirrel(squirrel), new UndoTreeSquirrel[]{}, "View "+(nViewsEverMade[0]-2/*omg this is outa control*/), squirrel, x+=w, 20, w, 700, nThingsDoneEver, nViewersAlive, nModelsEverMade, nViewsEverMade, nViewersEverMade, true, true, true, lengthizer, colorizer);
        }
