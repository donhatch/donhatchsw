...
// !!! THIS FILE WAS AUTOMATICALLY GENERATED BY javacpp; DO NOT EDIT !!!
// !!! THIS FILE WAS AUTOMATICALLY GENERATED BY javacpp; DO NOT EDIT !!!
// 102 # 1 "com/donhatchsw/util/Minimizer.prejava"
// 103 # 1 "<built-in>"
// 104 # 1 "<command-line>"
...
// 150 # 1 "com/donhatchsw/util/Minimizer.prejava"

// 152 # 1 "com/donhatchsw/util/Minimizer.prejava"
...
// XXX ... what a mess
// 171 # 9 "com/donhatchsw/util/Minimizer.prejava" 2
...
public class Minimizer
{
     ...
     */
    public static int verboseLevel = -1; // XXX really nothing; someone prints at 0
    ...
    public static double[] minimize(VectorFunction fun,
                                    double initialGuess[],
                                    double initialDelta,
                                    int maxCalls,
                                    boolean returnNullOnMaxCallsReached,
                                    String paramNames[])
    {
        if (verboseLevel >= 1)
        ...
        for (I = 0; (I) < (nTries); ++I)
        {
            ...
            if (verboseLevel >= 1) {System.out.print("        "); System.out.println("ftol" + " = " + (ftol));};
            ...
            if (nCalls >= maxCalls)
            {
                ...
                if (returnNullOnMaxCallsReached)
                    return null;
                else
                    return simplex[0];
            }
