...
// !!! THIS FILE WAS AUTOMATICALLY GENERATED BY javacpp; DO NOT EDIT !!!
// !!! THIS FILE WAS AUTOMATICALLY GENERATED BY javacpp; DO NOT EDIT !!!
// 102 # 1 "com/donhatchsw/awt/MyGraphics.prejava"
// 103 # 1 "<built-in>"
// 104 # 1 "<command-line>"
...
// 150 # 1 "com/donhatchsw/awt/MyGraphics.prejava"

// 152 # 1 "com/donhatchsw/awt/MyGraphics.prejava"
/* vim: set filetype=java: */
package com.donhatchsw.awt;
// 155 # 1 "com/donhatchsw/awt/macros.h" 1
//
// macros.h
//
// 159 # 14 "com/donhatchsw/awt/macros.h"
// NOTE: this causes a,b to be evaluated twice on failure, so is not ideal. might be better to do a block... ?
// 161 # 30 "com/donhatchsw/awt/macros.h"
// Note: the additional "(a)==(b)||" is to make it work correctly for infinities...
// and causes the args to be evaluated twice.
// 164 # 67 "com/donhatchsw/awt/macros.h"
// XXX ... what a mess
// 166 # 4 "com/donhatchsw/awt/MyGraphics.prejava" 2
/**
...
public class MyGraphics
{
    ...
    {
        int nSegs = ((10)>=((int)((((end-start)*c) < 0 ? -((end-start)*c) : ((end-start)*c)) / (1*(Math.PI/180))))?(10):((int)((((end-start)*c) < 0 ? -((end-start)*c) : ((end-start)*c)) / (1*(Math.PI/180))))); // 1 degree-- delicate tradeoff, if we make it too fine, it looks all warbly because the endpoints are snapped to unit pixel coords
        //PRINT(nSegs);
        ...
        for (i = 0; (i) < (nSegs+1); ++i)
        {
            double t = ((1-((double)i/nSegs))*(start) + ((double)i/nSegs)*(end));
                        ...
                        double startRadians, double arcRadians)
    {
        g.fillArc((int)Math.round(x * scaleX + translateX - 1), // FUDGE
                  ...
                  (int)Math.round(((startRadians)*(180./Math.PI))), (int)Math.round(((arcRadians)*(180./Math.PI))));
    } // fillArc
